...
<head>
    ...
    <style>
        ...
        .card-login { border-radius: 1.5rem; overflow: hidden; }
        .card-header-gradient { background: linear-gradient(135deg, #ff6b9d, #c084fc); }
        .btn-gradient { background: linear-gradient(135deg, #ff6b9d, #c084fc); border: none; color: white; transition: all 0.3s ease; }
        .btn-gradient:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(255, 107, 157, 0.4); color: white; }
        .input-group-text { background-color: #f8f9fa; border-right: 0; }
        .form-control { border-left: 0; background-color: #f8f9fa; }
        .form-control:focus { background-color: #fff; border-color: #ff6b9d; box-shadow: none; }
        .link-custom { color: #ff6b9d; text-decoration: none; font-weight: 600; }
        ...
        <div class="col-md-6 col-lg-5 col-xl-4">
            <div class="card card-login shadow-lg border-0">
                ...
                <div class="card-header card-header-gradient text-center py-4 border-0">
                    ...
                    <h4 class="text-white fw-bold mb-1">Selamat Datang Kembali</h4>
                    <p class="text-white-50 mb-0 small">Masuk ke akun Ice Cream Shop kamu</p>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <p class="text-center mb-0 text-secondary">
                        Belum punya akun? <a href="register.php" class="link-custom">Daftar sekarang</a>
                    </p>
                </div>
            </div>
